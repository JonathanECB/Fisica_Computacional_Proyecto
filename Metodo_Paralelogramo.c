//Este codigo obtiene la resultante a partir de 2 vectores con cierto angulo o sin angulo en comun al igual que la magnitud de ambos con el metodo del paralelogramo
